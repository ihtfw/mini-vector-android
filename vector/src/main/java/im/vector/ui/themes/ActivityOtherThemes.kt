...
sealed class ActivityOtherThemes(@StyleRes val light: Int,
    ...
    object NoActionBarFullscreen : ActivityOtherThemes(
            R.style.AppTheme_NoActionBar_FullScreen_Light,
    ...
    object Home : ActivityOtherThemes(
            R.style.HomeActivityTheme_Light,
    ...
    object Picker : ActivityOtherThemes(
            R.style.CountryPickerTheme_Light,
    ...
    object Search : ActivityOtherThemes(
            R.style.SearchesAppTheme_Light,
    ...
    object Call : ActivityOtherThemes(
            R.style.CallActivityTheme_Light,
